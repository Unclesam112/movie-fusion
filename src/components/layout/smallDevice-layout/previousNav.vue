  ...
  <main>
    <nav class="border-gray-200 dark:border-gray-700">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <div class="icon">
            <Icon icon="ion:arrow-back" width="25" class="text-gray-500"/>
        </div>
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
          ...
          >
            ...
            <li>
              <router-link to="/signin" type="button" class="text-white bg-red-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded text-sm px-4 py-2 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Sign in</router-link>
            </li>
          </ul>
        </div>
      </div>
