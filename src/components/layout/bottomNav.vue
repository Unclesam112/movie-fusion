<template>
    <div
        class="sm:hidden fixed z-50 w-full h-14 max-w-lg -translate-x-1/2 bg-white border border-gray-200  bottom-0 left-1/2 dark:bg-gray-700 dark:border-gray-600">
