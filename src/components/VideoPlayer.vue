<template>
    ...
    @onPause="handlePause"
     ...
     <main class="video-container relative rounded-lg" @mouseover="showControls = true" @mouseout="showControls = false" v-if="video" 
      style="height: 0; padding-bottom: 56.25%; overflow: hidden; z-index: 1;">
        <iframe class="rounded-lg" :src="getVideoUrl(video[0].key)" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
     </main>
</template>
