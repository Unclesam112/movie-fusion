<template>
    <div>
      ...
      <div class="grid grid-cols-5" v-if="topRatedActors.length > 0">
        <div v-for="actor in topRatedActors" :key="actor.name" @click="goToCast(actor.id)"  class="actor-card flex justify-center shadow">
          <div class="">
