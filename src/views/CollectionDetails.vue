    ...
    <main class="px-5">
        <div class="genre flex justify-between mt-5">
            ...
            <div class="flex gap-6">
                <Icon v-if="isEdit == true" icon="ph:pencil" width="20" @click.prevent="showDeleteButton()"/>
                <Icon icon="iconoir:cancel" v-if="isCancel == true" width="30"  @click.prevent="cancel()"/>
                <Icon v-if="addButton == true" icon="ic:round-plus" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
                    width="22" class="" type="button" />
