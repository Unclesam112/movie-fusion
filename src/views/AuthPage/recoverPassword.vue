        ...
        <div class="grid grid-cols-1 md:grid-cols-2 m-0">
            ...
            <div class="col">
                <div class=" text-left md:ml-40 ml-5 md:pt-5 pt-5">
                    <p class="text-gray-300">Back to <RouterLink to="/" class="text-red-700">Home</RouterLink>
                    </p>
                </div>
                <!-- ... (previous code) -->
                <form class="bg-white md:m-20 md:mt-0 md:mb-10 mt-10 md:p-20 md:pb-10 p-5 rounded ">
                    ...
                    <div class="text-center">
                        <button type="submit"
                            ...
                            class="bg-red-700 text-white w-full font-semibold py-2 px-4 rounded hover:bg-green-600 transition duration-300">
                    ...
                    <p class="text-gray-300">Don't have an account? <RouterLink to="/signup" class="text-red-700 font-semibold">Sign up</RouterLink>
                    </p>
                </div>
                </form>
            </div>
